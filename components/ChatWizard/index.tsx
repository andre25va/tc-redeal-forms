...
export default function ChatWizard({
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-slate-50 via-indigo-50/30 to-purple-50/20 flex flex-col">
      ...
      {/* ── Header ─────────────────────────────────────────────────────────── */}
      <div className="bg-white/90 backdrop-blur border-b border-gray-100 px-3 sm:px-4 py-2.5 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-2 min-w-0">
          <div className="w-8 h-8 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-xl flex items-center justify-center shadow-sm shrink-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-gray-400 truncate max-w-[130px] sm:max-w-[200px]">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <button
            onClick={onComplete}
            className="flex items-center gap-0.5 px-2.5 py-1.5 rounded-lg text-xs font-medium text-indigo-600 hover:bg-indigo-50 border border-indigo-200 transition-colors"
          >
      ...
      {/* ── Section pills ──────────────────────────────────────────────────── */}
      <div
        className="flex gap-1.5 px-3 py-2 overflow-x-auto bg-white/60 border-b border-gray-100"
      ...
      {/* ── Input area ─────────────────────────────────────────────────────── */}
      <div
        className="bg-white/90 backdrop-blur border-t border-gray-100 px-3 sm:px-4 pt-3 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]"
      ...
      >
        <div className="flex gap-2 items-end">
          <textarea
            ...
            rows={1}
            disabled={loading}
            className="flex-1 px-3.5 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm resize-none focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent transition-all disabled:opacity-60"
        ...
        <div className="flex items-center justify-between mt-1.5 pb-1 px-0.5">
