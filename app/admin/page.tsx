...
import { Plus, CheckCircle, Clock, AlertCircle, ExternalLink, Copy, MapPin, Eye } from 'lucide-react'
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl border border-gray-200 text-sm font-semibold text-gray-600 hover:bg-gray-50 transition-colors"
            >
              <Eye className="w-4 h-4 text-indigo-500" /> Preview Form
            </a>
            <button
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <h2 className="font-bold text-gray-900">Seller Disclosure Forms</h2>
          ...
          {loading ? (
            ...
            <div className="p-16 text-center">
              ...
              <p className="text-gray-500 text-sm mb-5">No invitations sent yet.</p>
              <button
                onClick={() => setShowForm(true)}
    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-6 max-h-[90vh] overflow-y-auto">
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            <h2 className="text-base font-bold text-gray-900">New Seller Disclosure Invitation</h2>
            <p className="text-xs text-gray-400">Fill in the details to send a form link</p>
          </div>
        </div>
        ...
        {created ? (
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <Field label="Property Address" value={form.property_address} onChange={e => setForm(p => ({ ...p, property_address: e.target.value }))} placeholder="123 Main St, City, TX 75000" />
            <div className="grid grid-cols-2 gap-3">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button type="submit" disabled={loading} className="flex-1 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold disabled:opacity-60 transition-all">
