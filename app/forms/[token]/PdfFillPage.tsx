...
export default function PdfFillPage({
  token, formName, pdfUrl, pageCount, fields, savedData, invitation,
}: PdfFillPageProps) {
  ...
  // Load pdf.js script + render all pages
  useEffect(() => {
    let cancelled = false
    ...
    function tryLoad() {
      ...
      if (document.getElementById('pdfjs-script')) {
        // Script tag exists but lib not ready yet
              ...
              <div className="flex rounded-lg overflow-hidden border border-gray-200 text-xs">
                <button
                  ...
                  className={`px-2 py-1 font-medium transition-colors ${
                    language === 'en' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-500 hover:bg-gray-50'
                  }`}
                >
                  EN
                </button>
                <button
                  ...
                  className={`px-2 py-1 font-medium transition-colors ${
                    language === 'es' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-500 hover:bg-gray-50'
                  }`}
                >
                  ES
                </button>
                  ...
                  return (
                    <input
                      ...
                      style={{
                        ...
                        cursor: 'pointer', accentColor: '#4f46e5',
                      }}
                    />
                  )
                }
